...
* [Manual Tagging - Essentials](implementing-nosto/manual-implementation/README.md)
  * [Setting up your account](implementing-nosto/manual-implementation/setting-up-your-account.md)
  * [Adding the Nosto Script](implementing-nosto/manual-implementation/add-nosto-script.md)
  * [Adding the Cart Tagging](implementing-nosto/manual-implementation/cart-tagging.md)
  * [Adding the Customer information](implementing-nosto/manual-implementation/adding-the-customer-information.md)
  * [Adding the Product Tagging](implementing-nosto/manual-implementation/product-tagging/README.md)
    * [Default Product Tagging](implementing-nosto/manual-implementation/product-tagging/default-product-tagging.md)
    * [Basic Tagging](implementing-nosto/manual-implementation/product-tagging/minimum-product-tagging.md)
  * [Adding the Category/Brand Tagging](implementing-nosto/manual-implementation/category-and-brand-tagging.md)
  * [Adding the Search Tagging](implementing-nosto/manual-implementation/search-tagging.md)
  * [Adding the Order Tagging](implementing-nosto/manual-implementation/order-tagging.md)
  * [Defining Nosto placements](implementing-nosto/manual-implementation/defining-nosto-placements.md)
  * [Tagging your page types](implementing-nosto/manual-implementation/tag-your-page-types.md)
* [Advanced Usage](implementing-nosto/advanced-implementation/README.md)
  * [Extending tagging with SKUs](implementing-nosto/advanced-implementation/extending-tagging-with-skus.md)
  * [Adding support for multi-currency](implementing-nosto/advanced-implementation/adding-support-for-multi-currency.md)
  * [Adding support for customer group pricing](implementing-nosto/advanced-implementation/adding-support-for-customer-group-pricing.md)
* [FAQ](implementing-nosto/faq.md)
