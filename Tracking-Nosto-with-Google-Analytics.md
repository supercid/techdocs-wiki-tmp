...
This document describes how to implement Enchanced Ecommerce tracking (product list impressions, product clicks and add to cart events) for Nosto recommendations using Google Analytics. This guide has been written with the assumption that your store uses [Google Tag Manger (GTM)](http://tagmanager.google.com/) and `dataLayer`.
...
![gtm_nosto_tracking_tag](https://user-images.githubusercontent.com/15191701/39805607-ff40eeaa-537f-11e8-8fa0-e6bdf733048d.png)
