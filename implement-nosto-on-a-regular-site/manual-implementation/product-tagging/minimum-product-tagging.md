...
In order to keep your product catalog in Nosto up to date, you must leverage the [Products API](../../../apis/apis/products/updating-products-using-the-products-api.md).
